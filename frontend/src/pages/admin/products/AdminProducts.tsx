            ...
            <div className="hidden md:block bg-white dark:bg-gray-900 rounded-[35px] border border-gray-100 dark:border-gray-800 overflow-hidden shadow-sm">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
                  {filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50/50 dark:hover:bg-black/40 transition-colors group">
                      <td className="p-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-widest">ID: {product.id}</p>
                          </div>
                        </div>
                      </td>
                      <td className="p-6">
