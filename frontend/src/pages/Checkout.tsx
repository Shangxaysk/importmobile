...
export default function Checkout() {
  ...
  // Bildirishnoma (Toast) uchun state
  ...
  // NUSXA OLISH VA TOASTNI KO'RSATISH
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black font-inter pb-32 transition-colors duration-300">
      ...
      <form onSubmit={handlePreSubmit} className="max-w-3xl mx-auto p-4 space-y-6 mt-2">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-teal-900 opacity-20 rounded-full blur-2xl transform -translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
          <div className="absolute -right-6 -bottom-6 opacity-10 transform -rotate-12 pointer-events-none transition-transform group-hover:scale-110 duration-500">
            <CreditCard size={160} />
          </div>
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-10">
              ...
              <div className="h-7 w-10 bg-gradient-to-br from-yellow-200 to-yellow-500 rounded-lg shadow-inner opacity-90 border border-yellow-300/50"></div>
            </div>
          ...
          <div className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl p-4 text-center hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
             {form.paymentReceipt ? (
               <div className="relative w-full max-w-[200px] mx-auto">
                 <img src={form.paymentReceipt} className="rounded-xl shadow-md w-full" />
      ...
      {/* FOOTER */}
      <div className="fixed bottom-0 left-0 right-0 z-[70] bg-white/90 dark:bg-black/90 backdrop-blur-lg border-t border-gray-100 dark:border-gray-800 pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
         <div className="max-w-3xl mx-auto px-5 py-4 flex items-center gap-4">
            ...
            <button onClick={handlePreSubmit} className="h-[54px] px-8 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-black text-sm rounded-[20px] shadow-xl active:scale-[0.98] transition-all flex items-center justify-center gap-2 uppercase tracking-wide">
